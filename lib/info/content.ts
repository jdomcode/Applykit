      ...
      sections: [
        {
          ...
          body: [
            "ApplyKit turns short form inputs into editable professional texts. The MVP is intentionally simple: choose a tool, complete a form, generate a result, edit it, copy it, and save it if you have an account.",
        ...
        },
        {
          ...
          body: [
            ...
            "The MVP includes public tools, account creation, saved documents, private history, basic analytics, SEO pages, and a production-ready deployment flow."
          ]
        }
      ],
      primaryAction: {
      ...
      sections: [
        {
          ...
          body: [
            "ApplyKit convierte formularios cortos en textos profesionales editables. El MVP es intencionalmente simple: eliges una herramienta, completas un formulario, generas un resultado, lo editas, lo copias y lo guardas si tienes cuenta.",
        ...
        {
          heading: "Alcance actual del MVP",
          body: [
            ...
            "El MVP incluye herramientas públicas, creación de cuenta, documentos guardados, historial privado, analítica básica, páginas SEO y despliegue preparado para producción."
          ]
        }
      ],
      primaryAction: {
      ...
      sections: [
        {
          ...
          body: [
            "Contact: contact@applykit.online",
            "For account, privacy, or saved-document requests, include the email address associated with your ApplyKit account. Do not send government ID numbers, financial information, medical information, or other unnecessary sensitive data."
          ]
        },
        {
          heading: "Feedback",
          body: [
            ...
            "Feedback helps improve templates while keeping the MVP simple and predictable."
          ]
        },
        {
          ...
          body: [
            ...
            "ApplyKit does not sell user conversations, saved documents, or generated content to advertisers."
          ]
        }
      ],
      primaryAction: {
        label: "Email ApplyKit",
        href: "mailto:contact@applykit.online"
      },
      secondaryAction: {
      ...
      sections: [
        {
          ...
          body: [
            "Contacto: contact@applykit.online",
            "Para solicitudes relacionadas con cuenta, privacidad o documentos guardados, incluye el correo asociado a tu cuenta de ApplyKit. No envíes números de identidad, información financiera, información médica u otros datos sensibles innecesarios."
          ]
        },
        {
          heading: "Comentarios",
          body: [
            ...
            "Los comentarios ayudan a mejorar las plantillas mientras el MVP se mantiene simple y predecible."
          ]
        },
        {
          ...
          body: [
            ...
            "ApplyKit no vende conversaciones, documentos guardados ni contenido generado de usuarios a anunciantes."
          ]
        }
      ],
      primaryAction: {
