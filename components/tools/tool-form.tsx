    ...
    <section className="rounded-[2rem] border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
      <div>
        ...
        <p className="mt-2 text-sm leading-6 text-slate-600">
          {locale === "es"
            ? "Completa los campos. El resultado se genera con la plantilla activa de la herramienta."
            : "Fill in the fields. The result is generated using the active template for this tool."}
        </p>
      </div>
